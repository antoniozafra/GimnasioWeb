...
<body>
    ...
    <div id="contenedor_principal">
        ...
        <h1 class="titulo_paginas"> VER EJERCICIOS</h1>
        ...
        <div id="ver_ejercicios" class="animated zoomIn delay-0s">
            ...
            if($c){
                ...
                $consulta = "select id_ejercicio,nombre,zona_muscular,pasos,nivel_dificultad,imagen from ejercicio";
