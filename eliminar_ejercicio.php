...
<head>
    ...
    <title>Panel de Control - Eliminar Ejercicio - COCOSPORT</title>
...
<body>
    ...
    <div id="contenedor_principal">
        ...
        <!--ZONA CLIENTES -->
        <h1 class="titulo_paginas">ELIMINAR EJERCICIO</h1>
        ...
        <div id="anadir_rutina" class="animated zoomInUp delay-0s">
            ...
            <form id="anadir_rutina_form" name="anadir_rutina" method="post" action="eliminar_ejercicio.php">
                <!--ID DEL USUARIO -->
                <label for="id_ejercicio">Id_ejercicio</label>
                <input type="number" name="id_ejercicio" id="id_ejercicio" required>
...
<?php
        ...
        //DATOS DE ACCESO DEL SERVIDOR
            ...
            //COMPROBAMOS SI EL FORMULARIO ESTA VACÍO PARA NO ENVIARLE LOS DATOS AL SERVIDOR
            ...
            $consulta="delete from ejercicio where id_ejercicio='".$id_ejercicio."' ";
            
            
            //COMPROBAMOS QUE LA RUTINA SE PUEDE INSERTAR CORRECTAMENTE
            if(mysqli_query($c,$consulta)){
                //MOSTRAMOS MENSAJE DE VALIDACIÓN
                echo "<p id='correcto'>EJERCICIO ELIMINADA CORRECTAMENTE</p>";

            } 
            else {
                //MOSTRAMOS MENSAJE DE EROS
                echo "<p id='error_cuestionario'>NO SE HA PODIDO ELIMINAR EL EJERCICIO</p>";
            }
