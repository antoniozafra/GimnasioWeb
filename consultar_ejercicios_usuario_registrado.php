...
<head>
    ...
    <title>Área Clientes - Consultar Ejercicios - COCOSPORT</title>
...
<body>
    ...
    <div id="contenedor_principal">
        ...
        <div id="filtros_ejercicios" class="animated  zoomIn delay-0s">
            ...
            <!--FORMULARIRO CON LOS FILTROS PARA LOS EJERCICIOS-->
            <form id="formulario_filtros" method="post" action="consultar_ejercicios_usuario_registrado.php">
                ...
                <button>Buscar Ejercicios</button>
        ...
        <div id="ver_ejercicios" class="animated  zoomIn delay-0s">
            ...
            if($c){
                ...
                echo "<table>"; //la propiedad empty-cells:show; permite visualizar las celdas vacias en la tabla.
                echo "<tr>";    
