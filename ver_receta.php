...
<head>
    ...
    <title>Panel de Control - Ver Receta - COCOSPORT</title>
...
<body>
    ...
    <div id="contenedor_principal">
        ...
        <h1 class="titulo_paginas"> VER RECETAS</h1>
        ...
        <div id="ver_ejercicios" class="animated zoomIn delay-0s">
            ...
            if($c){
                ...
                $consulta = "select id_Receta,nombre,tipo,ingredientes,pasos,tiempo_Estimado,nivel_dificultad,imagen from receta";
            ...
            echo "<table id='ver_receta'>"; 
           
                /*MOSTRAMOS LAS CABEZERAS DE LAS TABLAS*/
                echo "<th>Id_Receta</th>";
                echo "<th>Nombre</th>";
                echo "<th>Tipo</th>";
