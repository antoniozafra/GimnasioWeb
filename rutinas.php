...
<head>
    ...
    <title>Área Clientes - Rutinas - COCOSPORT</title>
...
<body>
    ...
    <div id="contenedor_principal">
        ...
        <h1 class="titulo_paginas">RUTINAS</h1>
...
<?php
            ...
            if($c){
                ...
                $consulta = "select anotaciones FROM rutina where id_usuario = (SELECT id_usuario from usuario where usuario='".$nombre_usuario."')";
            ...
            echo "<table id='dietas_mostrar' class='animated  zoomIn delay-0s'>";
                echo "<tr>";
                /*MOSTRAMOS EN NOMBRE DE LA COLUMNA DE LA TABLA*/
