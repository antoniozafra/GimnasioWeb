...
<head>
    ...
    <title>Panel de Control- Añadir Rutina - COCOSPORT</title>
...
<body>
    ...
    <div id="contenedor_principal">
        ...
        <!--ZONA CLIENTES -->
        <h1 class="titulo_paginas">AÑADIR RUTINA</h1>
        ...
        <div id="anadir_rutina" class="animated zoomInUp delay-0s">
            ...
            <form id="anadir_rutina_form" name="anadir_rutina" method="post" action="anadir_rutina.php">
                <!--ID DEL USUARIO -->
                ...
                <label for="rutina">Anotaciones: </label>
...
<?php
            ...
            //COMPROBAMOS QUE NO SE HA RELLENADO EL FORMULARIO PARA NO ENVIAR LOS DATOS
            if(empty($id_usuario)){
                exit();
            }
        ...
        if($c){
            ...
            $consulta="insert into rutina(Id_Usuario,Anotaciones) Values(".$id_usuario.",'".$rutina."')";
            
            //COMPROBAMOS QUE LA RUTINA SE PUEDE INSERTAR CORRECTAMENTE
            if(mysqli_query($c,$consulta)){
                //MOSTRAMOS MENSAJE DE VALIDACIÓN
                echo "<p id='correcto'>RUTINA AÑADIDA CORRECTAMENTE</p>";
            } 
            else {
                //MOSTRAMOS MENSAJE DE EROS
                echo "<p id='error_cuestionario'>NO SE HA PODIDO AÑADIR LA RUTINA</p>";
            }
